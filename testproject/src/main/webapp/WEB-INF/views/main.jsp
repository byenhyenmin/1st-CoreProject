            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <% if(loginDto != null) { %>
                  ...
                  <ul class="dropdown-menu">
                     ...
                     <li><a href="MypageCon.do?mem_id=<%=loginDto.getMem_id()%>">찜목록</a></li>
                  </ul></li>               
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<% if (list == null) { %>
				<div>
					<p><%=loginDto.getMem_id()%>님 환영합니다.
					</p>
					<button
						onclick="location.href='GoSurveyCon.do?mem_id=<%=loginDto.getMem_id()%>'">추천받기</button>
					<img src="#" class="img-responsive" style="width: 300%;"
						alt="Image">
					...
					%>
					<h3><%=list.getMem_id() %>님을 위한 추천 리스트</h3>

					<!-- 상점명 -->
					<p><%=list.getShop_name()%>상점명
					</p>
					<!-- 상점 이미지 -->
					<img src="<%=list.getShop_img() %>" class="img-responsive" style="width: 150%;" alt="Image">
					<button id="jjim" onclick="location.href='jjim.do?mem_id=<%=list.getMem_id()%>&shop_cd=<%=list.getShop_cd()%>'">찜하기</button>
